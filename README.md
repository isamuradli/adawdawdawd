...
|---|---|---|---|---|---|---|
| Adios | Soham | Code pushed to git | descriptions | 07/11/2025 | N/A | Request to update (add to description) |
| Arxiv | Isa | PR waiting approval | documentation | 07/11/2025 | N/A | - |
| Chronolog | Aum | Code pushed to git | documentation | - | - | - |
| Compression | Aum, Shazzadul | PR to be made | descriptions | - | Codebase PR not approved yet | - |
| HDF5 | Soham | PR to be made | descriptions | - | Codebase PR not approved yet | - |
| Jarvis | Jaime, Shazzadul | Discoverability (¼) | active development | 07/16/2025 | Ongoing development | - |
| Node Hardware | Shazzadul | PR to be made | descriptions | - | - | - |
| Pandas | Shazzadul | PR to be made | descriptions | - | Codebase PR not approved yet | - |
| Parallel Sort | Isa | Code pushed to git | documentation | 07/11/2025 | - | - |
| Plot | Shazzadul | Code pushed to git | descriptions | - | PR waiting approval | - |
| Slurm | Shazzadul | Code pushed to git | descriptions | - | - | - |
| Parquet | Shazzadul | PR to be made | descriptions | - | Codebase PR not approved yet | - |
